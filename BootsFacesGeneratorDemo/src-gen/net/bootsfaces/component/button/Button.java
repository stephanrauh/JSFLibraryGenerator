...
;
	...
	/**
	 * This attribute is mapped to the HTML5 data-dismiss custom attribute. <br />
	 * @return Returns the value of the attribute, or null, if it hasn't been set by the JSF file.
	 */
	...
	/**
	 * Font Awesome Icon to show in this Button, can be one of the Font Awesome icon names. Alignment can be specified with the iconAlign attribute. <br />
	 * @return Returns the value of the attribute, or null, if it hasn't been set by the JSF file.
	 */
	...
	/**
	 * Look of the Button, can be primary, block, info, success, warning, important, error, inverse. If not specified, Standard gray button with gradient is rendered. <br />
	 * @return Returns the value of the attribute, or null, if it hasn't been set by the JSF file.
	 */
