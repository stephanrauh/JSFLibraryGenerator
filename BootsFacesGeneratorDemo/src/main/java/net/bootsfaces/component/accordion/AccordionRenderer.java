...
public class AccordionRenderer extends CoreRenderer {
	...
	* to generate the rest of the HTML code.
	...
	public void encodeBegin(FacesContext context, UIComponent component) throws IOException {
		...
		rw.startElement("accordion", accordion);
		
	    rw.writeAttribute("id", accordion.getId(), "id");
	    rw.writeAttribute("rendered", String.valueOf(accordion.isRendered()), "rendered");
	    rw.writeAttribute("expandedPanels", accordion.getExpandedPanels(), "expandedPanels");
		rw.writeText("Dummy content of b:accordion", null);
